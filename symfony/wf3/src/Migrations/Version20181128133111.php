 ...
 */
final class Version20181128133111 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT AUTO_INCREMENT NOT NULL, brand_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', color VARCHAR(255) NOT NULL, model VARCHAR(255) NOT NULL, INDEX IDX_773DE69D44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE car_seat (car_id INT NOT NULL, seat_id CHAR(36) NOT NULL COMMENT \'(DC2Type:guid)\', INDEX IDX_F63622CAC3C6F69F (car_id), INDEX IDX_F63622CAC1DAFE35 (seat_id), PRIMARY KEY(car_id, seat_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
